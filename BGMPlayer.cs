...
public class BGMPlayer {
    ...
    class Wait : State {
        ...
        public override void playBGM() {
            bgmPlayer.fadeoutIs = fadeOutIs.notEnd;//あやしい・・・・この作り方自体・・・
    ...
    class FadeOut : State {
        ...
        public override void update() {
            ...
            if (t >= bgmPlayer.fadeOutTime) {
                ...
                bgmPlayer.source.Stop();
                bgmPlayer.state = new Wait(bgmPlayer);
                bgmPlayer.fadeoutIs = fadeOutIs.end;
            }
        }
    }
    ...
    public enum fadeOutIs {
        end,
        notEnd
    }
    public fadeOutIs fadeoutIs;
    ...
    public BGMPlayer(string bgmFileName) {
        ...
        if (clip != null) {
            ...
            Debug.LogWarning("BGM" + bgmFileName + "is not found.ないんじゃね？");
        }
    }
